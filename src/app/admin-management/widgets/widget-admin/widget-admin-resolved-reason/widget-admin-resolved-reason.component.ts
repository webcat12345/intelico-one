...
@Component({
  selector: 'one-admin-widget-admin-resolved-reason',
  templateUrl: './widget-admin-resolved-reason.component.html',
  styleUrls: ['./widget-admin-resolved-reason.component.scss'],
  animations: [flyIn(300, 330, true)]
})
export class WidgetAdminResolvedReasonComponent implements OnInit {

  @Input() apiUrl = 'Resolved';
  @Input() label: ISuperAdminTypeWindowLabel = {label: 'Resolved Reason', mLabel: 'Resolved Reason'};
