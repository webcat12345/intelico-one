...
@Component({
  selector: 'one-admin-widget-super-admin-types-add',
  templateUrl: './widget-super-admin-types-add.component.html',
  styleUrls: ['./widget-super-admin-types-add.component.scss']
})
export class WidgetSuperAdminTypesAddComponent implements OnInit {
